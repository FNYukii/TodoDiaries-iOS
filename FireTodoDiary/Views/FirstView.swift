...
struct FirstView: View {
    ...
    @ObservedObject var pinnedTodoViewModel = TodoViewModel(isPinned: true, isAchieved: false)
    @ObservedObject var unpinnedTodoViewModel = TodoViewModel(isPinned: false, isAchieved: false)
